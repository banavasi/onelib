...
export const SCRIPTS_VERSION = "0.2.5";
...
export type { AgentApplyOptions } from "./commands/agent-apply.js";
export { parseAgentApplyArgs, runAgentApply } from "./commands/agent-apply.js";
...
export type { AgentPlan, AgentPlanPage, PlanCapability } from "./agent/types.js";
export { PLAN_CAPABILITIES } from "./agent/types.js";
export { validateAgentPlan } from "./agent/validate.js";
export { compileAgentPlan } from "./agent/compile.js";
export { parseAgentPlanFile, applyAgentPlan } from "./agent/apply.js";
