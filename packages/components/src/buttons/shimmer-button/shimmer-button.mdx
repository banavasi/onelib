...
import * as ShimmerButtonStories from './shimmer-button.stories';

<Meta of={ShimmerButtonStories} />

# Shimmer Button

A button with an animated conic-gradient shimmer border effect. The shimmer continuously rotates around the button edge, creating an eye-catching CTA.
...
<Canvas of={ShimmerButtonStories.CustomText} />

### Group

Multiple shimmer buttons shown together.

<Canvas of={ShimmerButtonStories.Group} />

## Usage

Copy the component into your project at `src/components/buttons/shimmer-button/shimmer-button.tsx`:
...
Copy this file to `src/components/buttons/shimmer-button/shimmer-button.tsx`:
