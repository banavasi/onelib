...
A versatile button component with multiple variants, sizes, ripple click effect, loading state, and icon support.
...
Six visual variants: default, destructive, outline, secondary, ghost, and link.

<Canvas of={BasicButtonStories.AllVariants} />

### Sizes

Three sizes: small, default, and large.

<Canvas of={BasicButtonStories.Sizes} />

### Loading

Loading state disables interaction and shows a spinner.

<Canvas of={BasicButtonStories.Loading} />

### With Icons

Buttons with leading and trailing icons.

<Canvas of={BasicButtonStories.WithIcons} />

### Icon Only

Icon-only buttons with no text children.

<Canvas of={BasicButtonStories.IconOnly} />

## Usage

Copy the component into your project at `src/components/buttons/basic-button/basic-button.tsx`:
...
export default function MyPage() {
  return (
    <div className="flex gap-4">
      <BasicButton variant="default" size="default">
        Click me
      </BasicButton>
      <BasicButton variant="outline" size="sm">
        Cancel
      </BasicButton>
      <BasicButton variant="destructive" loading>
        Deleting...
      </BasicButton>
    </div>
  );
...
Copy this file to `src/components/buttons/basic-button/basic-button.tsx`:
